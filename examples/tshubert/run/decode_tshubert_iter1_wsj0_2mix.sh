...
expdir=${root_path}/exp/finetune_${lang}/train_wsj0_2mix/tshubert_base_iter1_libri2mix_train100_8x1gpu_finetune_train_wsj0_2mix_from_checkpoint_best
checkpoint=checkpoint_best.pt
test_sets="test_wsj0_2mix"
data=${root_path}/data
device=0
