...
expdir=${root_path}/exp/finetune_${lang}/train_2mix/tshubert_base_iter1_libri2mix_train100_8x1gpu_spk_adapter_cln_finetune_train_2mix_from_checkpoint_best
...
for test_set in $test_sets; do
    CUDA_VISIBLE_DEVICES=$device python ../speech_recognition/new/infer.py \
      ...
      task.load_enrollment_and_emb=true \
